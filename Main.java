...
public class Main {
    private static int MAX_JOB, NUM_ELEVATOR, NUM_FLOORS, SERVER_PORT, SCHEDULER_PORT, FLOOR_PORT;
...
//        Thread Elevator = new Thread(new ElevatorSubsystem(NUM_ELEVATOR, NUM_FLOORS, scheduler), "Elevator Thread");
        Thread Floor = new Thread(new FloorSubsystem(NUM_FLOORS, scheduler, schedulerStateMachine,FLOOR_PORT), "Floor Thread");
